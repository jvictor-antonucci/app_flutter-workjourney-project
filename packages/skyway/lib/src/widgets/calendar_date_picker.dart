...
const double _subHeaderHeight = 80.0;
const double _monthNavButtonsWidth = 150.0;
...
///    time picker.
///
class CalendarDatePickerWay extends StatefulWidget {
  ...
  @override
  _CalendarDatePickerWayState createState() => _CalendarDatePickerWayState();
}

class _CalendarDatePickerWayState extends State<CalendarDatePickerWay> {
  ...
  @override
  void didUpdateWidget(CalendarDatePickerWay oldWidget) {
              ...
              children: <Widget>[
                ...
                MediaQuery.removePadding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      setState(() {
                        _handleDateSelected(DateUtils.dateOnly(DateTime.now()));
                      });
                    },
                  ),
                ),
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle dayStyle = textTheme.bodyText1!;
...
/// [CalendarDatePickerWay], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [CalendarDatePickerWay], which provides a Material Design date picker
///    interface.
///
